      ...
      child: Column(
        ...
        children: [
          _buildSeccion(
            ...
            [
              _buildInfoRow(Icons.phone_rounded, 'Teléfono', widget.empresa.telefono),
              _buildInfoRow(Icons.email_rounded, 'Email', widget.empresa.email),
              _buildInfoRow(
                  Icons.location_on_rounded, 'Dirección', widget.empresa.direccion),
            ],
          ),
          ...
          const SizedBox(height: 16),
          if (widget.empresa.redesSociales.isNotEmpty)
            _buildSeccion(
              'Redes Sociales',
              Icons.share_rounded,
              widget.empresa.redesSociales
                  .map((red) => _buildSocialChip(red))
                  .toList(),
            ),
        ],
      ),
