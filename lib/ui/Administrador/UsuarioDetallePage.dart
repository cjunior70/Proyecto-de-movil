...
class Usuariodetallepage extends StatefulWidget {
  const Usuariodetallepage({super.key});
...
class _UsuariodetallepageState extends State<Usuariodetallepage> {
  ...
  void _cargarDatosusuario() async {
   ...
   final String? uid = prefs.getString('uid');
    ...
    if (usuario != null) {
      setState(() {
        cedulaCtrl.text = usuario!.Cedula ?? "";
        primerNombreCtrl.text = usuario!.PrimerNombre ?? "";
        segundoNombreCtrl.text = usuario!.SegundoNombre ?? "";
        primerApellidoCtrl.text = usuario!.PrimerApellido ?? "";
        segundoApellidoCtrl.text = usuario!.SegundoApellido ?? "";
        telefonoCtrl.text = usuario!.Telefono ?? "";
        correoCtrl.text = usuario!.Correo ?? "";
        sexoSeleccionado = usuario!.Sexo;
      });
    }
  ...
  void _guardarCambios() async {
    ...
    Usuario? usuarioActualizado = await UsuarioController().obtenerUsuario(_uid_global);
